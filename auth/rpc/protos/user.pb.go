...
var file_user_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x72, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65,
	...
	0x52, 0x65, 0x70, 0x65, 0x61, 0x74, 0x22, 0x2a, 0x0a, 0x10, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74,
	...
	0x75, 0x73, 0x32, 0x5b, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x53, 0x0a, 0x08, 0x52, 0x65,
	...
	0x0e, 0x22, 0x0c, 0x2f, 0x76, 0x31, 0x2f, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x42,
...
var file_user_proto_depIdxs = []int32{
	...
	1, // 1: protos.User.Register:output_type -> protos.RegisterResponse
...
func (c *userClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/protos.User/Register", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _User_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.User/Register",
	}
